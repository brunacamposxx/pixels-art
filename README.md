...
Projeto desenvolvido em novembro de 2020 por @brunacamposxx como avaliação de conhecimentos na @trybe
---
...
1. Clone o repositório
  * `git clone https://github.com/brunacamposxx/pixels-art`.
